...
int sc_main(int argc, char* argv[]) {
  options::GetMainOptions(argc, argv);
  ...
  GbTop gb_top("game_boy_top", options::rom_path, options::boot_rom_path, options::headless,
               options::wait_for_gdb, options::single_step);
