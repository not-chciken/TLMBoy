 ...
 *
 * Embedded DMG boot ROM data (DMG_ROM.bin), used when no boot ROM path is provided.
 ************************************************************************************/
...
static constexpr u8 kOriginalBoot[] = {
...
static constexpr u8 kQuickBoot[] = {
    0x31, 0xfe, 0xff, 0xaf, 0x21, 0xff, 0x9f, 0x32, 0xcb, 0x7c, 0x20, 0xfb, 0x21, 0x26, 0xff, 0x0e, 0x11, 0x3e, 0x80,
    0x32, 0xe2, 0x0c, 0x3e, 0xf3, 0xe2, 0x32, 0x3e, 0x77, 0x77, 0x3e, 0xfc, 0xe0, 0x47, 0xc3, 0xfc, 0x00, 0x00, 0x00,
...
unsigned int dmg_boot_bin_len = 256;

static constexpr std::span<const u8> kSpan{kOriginalBoot};
static constexpr std::span<const u8> kQuickBootSpan{kQuickBoot};
