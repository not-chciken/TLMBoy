...
TEST(BlarrgTest, cpuinstr02) {
  ...
  GbTop test_top("test_top", tlm_boy_root + "/roms/gb-test-roms/cpu_instrs/individual/02-interrupts.gb",
                              tlm_boy_root + "/roms/DMG_ROM.bin", options::headless);
  sc_start(8, SC_SEC);
  test_top.gb_ppu.game_wndw->SaveScreenshot("blarrgs_cpuinstr02.bmp");
